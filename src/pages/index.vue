...
<div>
   ...
   <span class="logintxt"><span @click="toLogin">登录</span >|<span @click="toAdmin">管理</span></span>
     ...
     align="center"
      ...
      <template slot-scope="scope">
        ...
        <span style="margin-left: 10px">
           ...
           <p>  <i class="el-icon-time"></i>{{$moment(scope.row.createtime).format('YYYY-MM-DD')}}</p>
